...
actions['chips0'] = 0
actions['pot'] = 0 # This is the sum of all pot from players
actions['bet'] = 0
...
roundName  = ''
smallBlind = 10
SB_player = rounds[rounds.position=='SB'][['round_id','playerName']].drop_duplicates().set_index('round_id')
BB_player = rounds[rounds.position=='BB'][['round_id','playerName']].drop_duplicates().set_index('round_id')
for idx,row in actions.iterrows():
    ...
    if row.round_id != round_id:
        ...
        players.loc[SB_player.loc[round_id],'smallBlind'] *= 2
        players.loc[SB_player.loc[round_id],'bet'] = smallBlind
        players.loc[BB_player.loc[round_id],'bet'] = 2*smallBlind
    ...
    actions.loc[idx,'pot']    = players.pot.sum() + players.bet.sum()
